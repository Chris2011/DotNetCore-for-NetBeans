 ...
 */
package org.chrisle.netbeans.plugins.csharp4netbeans.filetypes.config;
...
@DataObject.Registration(
        mimeType = "text/xml",
        iconBase = "org/chrisle/netbeans/plugins/csharp4netbeans/filetypes/config/config.png",
        displayName = "#LBL_Config_LOADER",
        position = 300
)
@ActionReferences({
