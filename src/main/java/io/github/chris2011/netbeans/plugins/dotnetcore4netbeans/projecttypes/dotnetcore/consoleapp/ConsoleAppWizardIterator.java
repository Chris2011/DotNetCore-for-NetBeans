package io.github.chris2011.netbeans.plugins.dotnetcore4netbeans.projecttypes.dotnetcore.consoleapp;
...
@TemplateRegistrations({
    @TemplateRegistration(folder = "Project/.NET/.NET Core", displayName = "#ConsoleApp_displayName", description = "ConsoleAppDescription.html", iconBase = "io/github/chris2011/netbeans/plugins/dotnetcore4netbeans/projecttypes/dotnetcore/consoleapp/console-16.png", position = 200)
})
...
//    }
    private Runnable createDotNetCliApp() {
        ...
        final Boolean inSameDirProperty = (Boolean) wiz.getProperty("sameDir");
        final boolean inSameDir = inSameDirProperty != null ? inSameDirProperty.booleanValue() : false;
