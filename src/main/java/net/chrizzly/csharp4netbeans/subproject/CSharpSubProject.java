...
public class CSharpSubProject implements Project {
    ...
    private final class CSharpSubProjectLogicalView implements LogicalViewProvider {
        @StaticResource()
        public static final String PROJECT_ICON = "net/chrizzly/csharp4netbeans/cs-project-nb.png";
...
//                        new FilterNode.Children(node),
    ...
    private final class Info implements ProjectInformation {
        @StaticResource()
        public static final String CSHARP_ICON = "net/chrizzly/csharp4netbeans/cs-project-folder.png";
