...
import net.chrizzly.dotnetcore4netbeans.project.csharp.CSharpSubProjectProvider;
...
public class CSharpSolution implements Project {
    ...
    private final class CSharpSolutionLogicalView implements LogicalViewProvider {
        @StaticResource()
        public static final String SOLUTION_ICON = "net/chrizzly/dotnetcore4netbeans/sln-file-nb.png";
    ...
    private final class Info implements ProjectInformation {
        @StaticResource()
        public static final String SLN_ICON = "net/chrizzly/dotnetcore4netbeans/sln-file-nb.png";
