package net.chrizzly.dotnetcore4netbeans.project.csharp.nodes.ReferencesNode;
...
public class ReferencesNode extends AbstractNode {
    ...
    @StaticResource
    private static final String IMAGE = "net/chrizzly/dotnetcore4netbeans/references.png";
