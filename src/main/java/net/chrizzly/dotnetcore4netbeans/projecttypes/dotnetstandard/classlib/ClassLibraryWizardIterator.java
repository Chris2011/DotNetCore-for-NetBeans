...
//    @TemplateRegistration(folder = "Project/.NET/.NET Standard", displayName = "#ClassLibrary_displayName", description = "ClassLibraryDescription.html", iconBase = "net/chrizzly/dotnetcore4netbeans/projecttypes/dotnetstandard/classlib/dll-16.png"),
})
